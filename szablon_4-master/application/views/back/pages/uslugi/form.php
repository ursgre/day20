                    ...
                    <div class="row"> <!-- set -->
                        ...
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force">
                                <label class="form-control-label">Kod ikony z <a href="https://fontawesome.com/">FontAwesome</a>:
                                    <?php if(@$value->icon != ''){echo '<i class="'.@$value->icon.'"></i>';} ?>
                                </label>
                                <input class="form-control" type="text" name="icon" value="<?php echo @$value->icon; ?>">
                            </div>
                        </div><!-- col-4 -->
                    </div> <!-- set -->
                    <div class="row"> <!-- set -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        <div id="photoViewer_2" class="form-group bd-l-0-force text-center delete_photo cursor" onclick="clear_box(2);">
                            <?php if(@$value->photo_2 != '') {
                                echo '<img class="img-fluid img-thumbnail" src="' . base_url() . 'uploads/' . $value->photo_2 . '" width=75%>';
                            } else {
                                echo '<img class="img-fluid img-thumbnail" src="http://via.placeholder.com/64x64" alt="">';
                            } ?>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group bd-t-0-force bd-l-0-force">
                        <label class="form-control-label">Zdjęcie baneru:</label>
                    ...
                    <div class="col-md-12">
                        <div id="photoViewer_2" class="form-group bd-t-0-force bd-l-0-force">
                            <label class="form-control-label">Tekst alternatywny zdjęcia:</label>
                            <input class="form-control" type="text" name="alt_2" value="<?php echo @$value->alt_2; ?>">
                        </div>
                    </div><!-- col-12 -->
                </div>
            </div><!-- row -->
