                    ...
                    <div class="row"> <!-- set -->
                        ...
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-t-0-force bd-b-0-force bd-l-0-force bd-r-0-force">
                                <label class="form-control-label">Tekst linku:</label>
                                <input class="form-control" type="text" name="link_text" value="<?php echo @$value->link_text; ?>">
                            </div>
                        </div><!-- col-4 -->
                    </div> <!-- set -->
                    <div class="row"> <!-- set -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-b-0-force bd-r-0-force">
                                <label class="form-control-label">Kolor tekstu:</label>
                                <input class="w-100" type="color" name="color" value="<?php echo @$value->color; ?>">
                            </div>
                        </div><!-- col-4 -->
                    </div> <!-- set -->
                    <div class="row">
