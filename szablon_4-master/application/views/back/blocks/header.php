<!-- ########## START: LEFT PANEL ########## -->
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <?php if($this->uri->segment(2) == 'glowna_baner' || $this->uri->segment(2) == 'nazwy_sekcji' || $this->uri->segment(2) == 'pasek_pod_banerem'  || $this->uri->segment(2) == 'specialna_sekcja'){echo 'active show-sub';} ?>">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item">
            <a href="<?php echo base_url();?>panel/glowna_baner" class="nav-link <?php if($this->uri->segment(2) == 'glowna_baner'){echo 'active';} ?>">
              Banner
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>panel/pasek_pod_banerem" class="nav-link <?php if($this->uri->segment(2) == 'pasek_pod_banerem'){echo 'active';} ?>">
              Pasek pod banerem
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>panel/nazwy_sekcji" class="nav-link <?php if($this->uri->segment(2) == 'nazwy_sekcji'){echo 'active';} ?>">
              Nazwy sekcji
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>panel/specialna_sekcja" class="nav-link <?php if($this->uri->segment(2) == 'specialna_sekcja'){echo 'active';} ?>">
              Specialna sekcja
            </a>
          </li>
        </ul>
        ...
        <?php if($this->uri->segment(2) == 'naglowki'){echo 'active';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fas fa-heading tx-20"></i>
            <span class="menu-item-label">Nagłówki</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <a href="#" class="br-menu-link
        <?php if($this->uri->segment(2) == 'ofirmie_ekipa' || $this->uri->segment(2) == 'ofirmie_sekcja_1' || $this->uri->segment(2) == 'ofirmie_sekcja_2'){echo 'active show-sub';} ?>">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item">
            <a href="<?php echo base_url();?>panel/ofirmie_ekipa" class="nav-link <?php if($this->uri->segment(2) == 'ofirmie_ekipa'){echo 'active';} ?>">
              Ekipa
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>panel/ofirmie_sekcja_1" class="nav-link <?php if($this->uri->segment(2) == 'ofirmie_sekcja_1'){echo 'active';} ?>">
              Sekcja pierwsza
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>panel/ofirmie_sekcja_2" class="nav-link <?php if($this->uri->segment(2) == 'ofirmie_sekcja_2'){echo 'active';} ?>">
              Sekcja druga
            </a>
          </li>
        </ul>
        <a href="<?php echo base_url(); ?>panel/uslugi" class="br-menu-link
        <?php if($this->uri->segment(2) == 'uslugi'){echo 'active';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fab fa-buffer tx-20"></i>
        ...
        <a href="<?php echo base_url(); ?>panel/galeria" class="br-menu-link
        <?php if($this->uri->segment(2) == 'galeria'){echo 'active';} ?>">
          <div class="br-menu-item">
