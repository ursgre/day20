...
class Base_m extends CI_Model
{
    ...
    {
        return $this->db->query('CREATE TABLE ' . $new_table . ' LIKE ' . $old_table . ';');
    }
    ...
    public function create_int_column($table, $name)
    {
        return $this->db->query('ALTER TABLE ' . $table . ' ADD ' . $name . ' int(11); ');
    }
    public function create_boolean_column($table, $name)
    {
        return $this->db->query('ALTER TABLE ' . $table . ' ADD ' . $name . ' tinyint(1); ');
    }
