    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody mg-t-0 pd-x-30">
            ...
            <form class="form-layout form-layout-2"
                action="<?php echo base_url(); ?>panel/<?php echo $this->uri->segment(2); ?>/action/<?php echo $this->uri->segment(4) . '/' . $this->uri->segment(2) . '/' . $value->id; ?>"
                ...
                <div class="row no-gutters">
                        ...
                        <div class="row">
                            <div class="col-md-6 pr-0">
                                <div class="form-group">
                                    <label class="form-control-label">Nazwa strony w menu: <span
                        ...
                        <div class="row">
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-t-0-force">
                                    <label class="form-control-label">Meta opis strony:</label>
                                    <textarea class="summernote"
                    ...
                    <div class="col-md-4">
                        <div class="col-md-12">
                            <div id="photoViewer_1" class="form-group bd-l-0-force text-center" onclick="clear_box(1);">
                                <?php if ($value->photo != '') {
