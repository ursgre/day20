                ...
                <table id="datatable1" class="table display responsive nowrap">
                    <thead>
                        <tr>
                            ...
                            <th class="wd-25p align-top">Tytuł</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <input class="form-control order-input" id="getOrder<?= $value->id ?>"
                                    name="record_order" onkeyup="changeOrder(<?= $value->id ?>)"
                                    value="<?= @$value->record_order ?>">
                            </td>
