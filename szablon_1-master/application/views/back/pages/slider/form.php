                ...
                <div class="col-md-8">
                    <div class="row"> <!-- set -->
                        <div class="col-md-6 pr-0">
                            <div class="form-group bd-b-0-force" id="title_div">
                                <label class="form-control-label">Tytuł: <span class="tx-danger">*</span></label>
                                <input class="form-control" type="text" id="slider_title" name="title" value="<?php echo $value->title; ?>">
                            </div>
                        </div><!-- col-4 -->
                    ...
                    <div class="row"> <!-- set -->
                        <div class="col-md-6 pr-0 bd-b-0-force bd-t-0-force">
                    ...
                    <div class="row">
                        <div class="col-md-12 pr-0">
                            <div class="form-layout-footer bd bd-t-0-force pd-20 bd-r-0-force">
                                <button class="btn btn-info" id="submit" type="submit">Zapisz</button>
