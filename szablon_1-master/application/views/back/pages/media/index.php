            ...
            <div class="table-wrapper">
              ...
              foreach (array_reverse($rows) as $value) : $i++;  ?>
                        <tr>
                            ...
                            <td class="align-middle"><?php echo substr($value->raw_name, 0, titleLength());
                                            if (strlen($value->raw_name) > titleLength()) echo '...' ?></td>
                            <td class="text-right"><a class="btn btn-primary btn-sm"
                                    href="<?php echo base_url(); ?>uploads/<?php echo date('Y-m-d', strtotime($value->created)); ?>/<?php echo $value->name; ?>"
                                    target="_blank"><i class="fas fa-link mg-r-10"></i>Link</a>
