    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody mg-t-0 pd-x-30">
        ...
        <?php endif; ?>
          ...
          <form class="form-layout form-layout-2" action="<?php echo base_url(); ?>panel/<?php echo $this->uri->segment(2); ?>/action/<?php echo $this->uri->segment(4) . '/' . $this->uri->segment(2) . '/' . @$value->id; ?>" method="post" id="panel_form" enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                    ...
                    <div class="row"> <!-- set -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-1-force bd-b-0-force ">
