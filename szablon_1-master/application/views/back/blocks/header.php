...
<div class="br-sideleft overflow-y-auto">
    ...
    <div class="br-sideleft-menu">
        ...
        <?php if ($this->uri->segment(2) == 'slider' || $this->uri->segment(2) == 'parallax' || $this->uri->segment(2) == 'atributes') {
            echo 'active';
        } ?>">
            <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="<?php echo base_url(); ?>panel/parallax/form/update/1"
                    class="nav-link <?php if ($this->uri->segment(2) == 'parallax' || $this->uri->segment(3) == 'parallax') {
                                                                                                                        echo 'active';
                                                                                                                    } ?>">Parallax</a></li>
        ...
        <a href="<?php echo base_url(); ?>panel/about/form/update/1" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'about') {
            echo 'active';
        } ?>">
            <div class="br-menu-item">
                <i class="menu-item-icon icon fas fa-circle tx-20"></i>
        ...
        <a href="<?php echo base_url(); ?>panel/offer" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'offer') {
            echo 'active';
        } ?>">
            <div class="br-menu-item">
                <i class="menu-item-icon icon fas fa-square tx-20"></i>
                <span class="menu-item-label">Oferta</span>
            </div>
        </a>
        <a href="<?php echo base_url(); ?>panel/settings/gallery/gallery_page/1" class="br-menu-link
        ...
        <!-- <a href="<?php echo base_url(); ?>panel/jezyki" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'jezyki' || $this->uri->segment(4) == 'jezyki') {
            echo 'active';
        } ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fas fa-flag tx-20"></i>
            <span class="menu-item-label">Języki</span>
          </div>
        </a> -->
        <a href="<?php echo base_url(); ?>panel/naglowki" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'naglowki' || $this->uri->segment(4) == 'naglowki') {
            echo 'active';
        } ?>">
            <div class="br-menu-item">
        ...
        <a href="<?php echo base_url(); ?>panel/kontakt" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'kontakt' || $this->uri->segment(4) == 'kontakt') {
            echo 'active';
        } ?>">
            <div class="br-menu-item">
        ...
        <a href="<?php echo base_url(); ?>panel/scripts" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'scripts') {
            echo 'active';
        } ?>">
            <div class="br-menu-item">
                <i class="menu-item-icon icon fas fa-code tx-20"></i>
                <span class="menu-item-label">Własne skrypty</span>
            </div>
        </a>

        <!-- 
        <a href="<?php echo base_url(); ?>panel/example" class="br-menu-link
        <?php if ($this->uri->segment(2) == 'example') {
            echo 'active';
        } ?>">
            <div class="br-menu-item">
        ...
        <?php $links = ['Nazwa 1' => 'link-1', 'Nazwa 2' => 'link-2']; ?>
        <a href="#" class="br-menu-link
...
<div class="br-header">
    ...
    <div class="br-header-right">
        <nav class="nav">
            <!-- <form class="nav-link pd-x-7 pos-relative d-flex align-items-center" id="form_lang" action="<?= base_url() ?>panel/settings/set_lang" method="post">
    ...
    <div class="tab-content">
                    ...
                    <div class="pd-y-20 pd-l-25 tx-white">
                        ...
                        <div class="pos-relative">
                            <input type="text" id="label2" name="label2"
                                onchange="updateField('label2' , 'contact_settings')"
                                value="<?php echo $contact->label2; ?>"
                                class="form-control form-control-inverse transition pd-y-10">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pd-y-20 pd-r-25 tx-white">
                        ...
                        <div class="pos-relative">
                            <input type="text" id="phone2" name="phone2"
                                onchange="updateField('phone2' , 'contact_settings')"
                                value="<?php echo $contact->phone2; ?>"
                                class="form-control form-control-inverse transition pd-y-10">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="pd-y-20 pd-l-25 tx-white">
                        <h6 class="tx-13 tx-normal">Etykieta:</h6>
                        <div class="pos-relative">
                            <input type="text" id="label4" name="label4"
                                onchange="updateField('label4' , 'contact_settings')"
                                value="<?php echo $contact->label4; ?>"
                                class="form-control form-control-inverse transition pd-y-10">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pd-y-20 pd-r-25 tx-white">
                        ...
                        <div class="pos-relative">
                            <input type="text" id="email2" name="email2"
                                onchange="updateField('email2' , 'contact_settings')"
                                value="<?php echo $contact->email2; ?>"
                                class="form-control form-control-inverse transition pd-y-10">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pd-y-20 pd-l-25 tx-white">
                        ...
                        <div class="pos-relative">
                            <input type="text" id="label5" name="label5"
                                onchange="updateField('label5' , 'contact_settings')"
                                value="<?php echo $contact->label5; ?>"
                                class="form-control form-control-inverse transition pd-y-10">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pd-y-20 pd-r-25 tx-white">
                        ...
                        <div class="pos-relative">
                            <input type="text" id="hours" name="hours"
                                onchange="updateField('hours' , 'contact_settings')"
                                value="<?php echo $contact->hours; ?>"
                                class="form-control form-control-inverse transition pd-y-10">
                        </div>
                    </div>
                </div>
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="settings" role="tabpanel">
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="color" id="first_color" name="first_color"
                        onchange="updateField('first_color' , 'settings')" value="<?php echo $settings->first_color; ?>"
                        class="form-control form-control-inverse transition pd-y-5">
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="color" id="second_color" name="second_color"
                        onchange="updateField('second_color' , 'settings')"
                        value="<?php echo $settings->second_color; ?>"
                        class="form-control form-control-inverse transition pd-y-5">
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="tw_link" name="tw_link" onchange="updateField('tw_link' , 'settings')"
                        value="<?php echo $settings->tw_link; ?>"
                        class="form-control form-control-inverse transition pd-y-10">
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="inst_link" name="inst_link" onchange="updateField('inst_link' , 'settings')"
                        value="<?php echo $settings->inst_link; ?>"
                        class="form-control form-control-inverse transition pd-y-10">
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                ...
                <div class="pos-relative">
                    <input type="text" id="yt_link" name="yt_link" onchange="updateField('yt_link' , 'settings')"
                        value="<?php echo $settings->yt_link; ?>"
                        class="form-control form-control-inverse transition pd-y-10">
                </div>
            </div>
            ...
            <div class="pd-y-20 pd-x-25 tx-white">
                <h6 class="tx-13 tx-normal">Zgoda rodo telefoniczna:</h6>
                <p class="op-5 tx-13">Klauzula RODO</p>
                <div class="pos-relative">
                    <textarea id="rodo_tel" name="rodo_tel" rows="5"
                        onfocusout="updateTextarea('rodo_tel' , 'settings')"
                        class="form-control form-control-inverse transition pd-y-10"><?php echo $settings->rodo_tel; ?></textarea>
                </div>
            </div>
