<!-- ########## START: LEFT PANEL ########## -->
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <?php if($this->uri->segment(2) == 'slider' || $this->uri->segment(2) == 'parallax' || $this->uri->segment(2) == 'atributes'){echo 'active';} ?>">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/slider" class="nav-link <?php if($this->uri->segment(2) == 'slider' || $this->uri->segment(3) == 'slider'){echo 'active';} ?>">Slider</a></li>
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/parallax/form/update/1" class="nav-link <?php if($this->uri->segment(2) == 'parallax' || $this->uri->segment(3) == 'parallax'){echo 'active';} ?>">Parallax</a></li>
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/atributes" class="nav-link <?php if($this->uri->segment(2) == 'atributes' || $this->uri->segment(3) == 'atributes'){echo 'active';} ?>">Cechy</a></li>
        </ul>
        <a href="<?php echo base_url(); ?>panel/about/form/update/1" class="br-menu-link
        <?php if($this->uri->segment(2) == 'about'){echo 'active';} ?>">
          <div class="br-menu-item">
        ...
        <?php if($this->uri->segment(2) == 'offer'){echo 'active';} ?>">
          <div class="br-menu-item">
        ...
        <?php if($this->uri->segment(4) == 'gallery_page'){echo 'active';} ?>">
          <div class="br-menu-item">
