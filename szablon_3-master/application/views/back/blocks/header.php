<!-- ########## START: LEFT PANEL ########## -->
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <?php if($this->uri->segment(2) == 'glowna_baner' || $this->uri->segment(2) == 'glowna_oferta' || $this->uri->segment(2) == 'pasek_pod_banerem'  || $this->uri->segment(2) == 'glowna_przycisk'){echo 'active show-sub';} ?>">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>panel/glowna_przycisk" class="nav-link <?php if($this->uri->segment(2) == 'glowna_przycisk'){echo 'active';} ?>">
              Przycisk w menu
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>panel/glowna_oferta" class="nav-link <?php if($this->uri->segment(2) == 'glowna_oferta'){echo 'active';} ?>">
              Oferta
            </a>
          </li>
        </ul>
        ...
        <a href="#" class="br-menu-link
        <?php if($this->uri->segment(2) == 'ofirmie_ikony' || $this->uri->segment(2) == 'ofirmie_sekcja_1' || $this->uri->segment(2) == 'ofirmie_sekcja_2'){echo 'active show-sub';} ?>">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>panel/ofirmie_ikony" class="nav-link <?php if($this->uri->segment(2) == 'ofirmie_ikony'){echo 'active';} ?>">
              Ikony
            </a>
          </li>
        </ul>
